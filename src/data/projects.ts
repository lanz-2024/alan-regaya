...
export const projects: Project[] = [
  ...
  },
  {
    ...
    liveUrl: 'https://byronbaycandles.com.au',
  ...
  },
  {
    ...
    tech: ['Next.js', 'TypeScript', 'WooCommerce', 'Blocksy', 'Tailwind CSS'],
    liveUrl: 'https://porselli.co.uk',
  ...
  },
  {
    ...
    tech: ['WordPress', 'WooCommerce', 'PHP', 'JavaScript', 'Blocksy'],
  ...
  },
  {
    ...
    name: 'Kajal Naina',
    type: 'in-development',
    description: 'South Asian bridal wear boutique with a virtual try-on feature, appointment booking system, and curated lookbook collections.',
    tech: ['Next.js', 'TypeScript', 'WooCommerce', 'Blocksy', 'Tailwind CSS'],
    liveUrl: 'https://kajalnaina.com',
    screenshot: '/screenshots/kajalnaina.png',
  },
  {
